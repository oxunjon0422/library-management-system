...
public class BookDao {
    ...
    public static boolean addNewBook(Book book) {
        ...
        try {
            ...
            String insertBook = "insert into book (title, description,category_id, \"imgurl\",quantity,isbn,year ) VALUES " +
                    "(?, ?, ?, ?,?,?,?)";
    ...
    public static void update(Book book) {
        ...
        try {
            PreparedStatement preparedStatement1 = connection1.prepareStatement("update  book set title=?,description=?,category_id=?, \"imgurl\"=?,quantity=?,isbn=?,year=?  where id=? ");
            preparedStatement1.setString(1, book.getTitle());
            preparedStatement1.setString(2, book.getDescription());
